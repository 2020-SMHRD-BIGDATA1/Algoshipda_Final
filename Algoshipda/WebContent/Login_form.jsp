		...
		<div class="col-lg-4">
			...
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<form method="post" action="LoginService">
					<h3 style="text-align: center; font-family: 'Jalnan';color:white; font-size: 50px;">LOGIN</h3>
			...
			<center>
			<input type="submit" value="로그인" class="btn_ej" style="font-family: 'Jalnan';"> <input
				type="button" value="회원가입" " class="btn_ej" style="font-family: 'Jalnan';"
